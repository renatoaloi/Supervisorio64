/*
  ...
  05/20/13  - renato.aloi@gmail.com - Update for arduino0105
  05/29/13  - renato.aloi@gmail.com - Morphing to Supervisorio64 Plataform (seriallink.com.br for more info)
*/
...
#define analogInputToDigitalPin(p)  ((p < 6) ? (p) + 24 : -1)
